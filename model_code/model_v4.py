...
class ResNet_v4(nn.Module):
    def __init__(self, input_channels=3, output_dim=9, res_blocks=40, lr=0.002, weight_decay=1e-4):
        super(ResNet_v4, self).__init__()
    ...
    def save(self, epoch):
        ...
        torch.save(self.state_dict(), f"models/model_v4/model_{epoch}.pt")

    def load(self, epoch):
        print(f"Loading model at epoch {epoch}")
        self.load_state_dict(torch.load(f"models/model_v4/model_{epoch}.pt"))

    def save_latest(self):
        print("Saving latest model")
        torch.save(self.state_dict(), "models/model_v4/model_latest.pt")

    def load_latest(self):
        print("Loading latest model")
        self.load_state_dict(torch.load("/home/payton/projects/alphazero/models/model_v4/model_latest.pt"))
